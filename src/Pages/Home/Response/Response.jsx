  ...
  return (
    <div className="carousel w-full pt-20">
      ...
      <div id="slide3" className="carousel-item relative w-full">
        ...
        <p className="text-center text-base w-80 mx-auto pb-20 pt-5">Spending time and working successfully can lead to personal fulfillment and achievement. If you have any specific questions or anything you`d like to discuss about business management, productivity, or work-related topics, feel free to let me know!</p>
        </div>
        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
          <a href="#slide2" className="btn btn-circle">
            ❮
